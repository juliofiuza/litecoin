...
"""Verify that starting emolumento with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start emolumento with -h for help text")
        ...
        self.log.info("Start emolumento with -version for version information")
        ...
        self.log.info("Start emolumentod with -fakearg to make sure it does not start")
