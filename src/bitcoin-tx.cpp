...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " emolumento-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  emolumento-tx [options] <hex-tx> [commands]  Update hex-encoded emolumento transaction\n" +
            "or:     emolumento-tx [options] -create [commands]   Create hex-encoded emolumento transaction\n" +
            "\n";
