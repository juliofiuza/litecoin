Emolumento Core version *0.15.1* is now available from:

  <https://download.emolumento.org/emolumento-0.15.1/>
...
A number of changes to the way Emolumento Core deals with peer connections and invalid blocks
