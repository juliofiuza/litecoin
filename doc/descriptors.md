# Support for Output Descriptors in Emolumento Core

Since Emolumento Core v0.17, there is support for Output Descriptors. This is a
...
on Emolumento's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Emolumento Core wallets, a convenience function `combo` is
