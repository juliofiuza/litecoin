...
By default, Emolumento Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that emolumento's trustless model works best if you are
